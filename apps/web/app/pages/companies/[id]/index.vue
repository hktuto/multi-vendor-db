...
function cancelEdit() {
    if (company.value) {
        ...
        editForm.settings = {
            ...
            dateFormat:
                (company.value.settings as any)?.dateFormat || "YYYY-MM-DD",
            defaultLanguage:
                (company.value.settings as any)?.defaultLanguage || "en",
        };
    }
    isEditing.value = false;
    editErrors.name = "";
                            ...
                            <UCard>
                                ...
                                <div class="space-y-4">
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            <label class="text-sm text-dimmed"
                                                >Name</label
                                            >
                                            <p class="font-medium">
                                                {{ company.name }}
                        ...
                        <UCard>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <UFormField label="Timezone">
                                    <USelect
                                        v-model="editForm.settings.timezone"
                                        :items="timezones"
                                        class="w-full"
                                    />
                                </UFormField>
                                ...
                                <UFormField label="Language">
                                    <USelect
                                        v-model="
                                            editForm.settings.defaultLanguage
                                        "
                                        :items="
                                            languages.map((l) => ({
                                                label: l.label,
