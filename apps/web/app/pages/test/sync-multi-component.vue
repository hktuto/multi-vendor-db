...
import { useElectricSync } from "../../composables/useElectricSync";
...
<template>
    <div class="p-6 max-w-6xl mx-auto overflow-auto">
        <!-- 頁面標題 -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900">
                🧪 Sync Lab - 多組件同 Table 測試
            </h1>
        ...
        <div class="mb-8">
            ...
            >
                <p class="text-sm text-green-800">
                    💡 <strong>預期行為：</strong> 更新當前用戶名稱， 所有訂閱
                    <code>users</code> table 的組件應該收到
                    <strong>update</strong> 事件。
                </p>
            </div>
        ...
        <div class="mb-8">
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                <p class="text-sm text-blue-800">
                    💡 <strong>預期行為：</strong> 三個組件同時訂閱
                    <code>users</code> table， 底層應該只有
                    <strong>1 個 ShapeStream</strong>。
                    取消其中一個，另外兩個應該繼續收到事件。
                </p>
            </div>
        ...
        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
            ...
            >
                <li>觀察「測試 1」的三個組件是否都顯示 🟢 訂閱中</li>
                <li>
                    檢查全局狀態：<code>users</code> table 應該顯示
                    <strong>3 個訂閱者</strong>
                </li>
                <li>點擊「組件 A」的「取消訂閱」按鈕</li>
                <li>
                    檢查全局狀態：<code>users</code> table 應該變成
                    <strong>2 個訂閱者</strong>
                </li>
                <li>繼續取消 B 和 C，當最後一個取消時 shape 應該完全清理</li>
                <li>測試「測試 2」的不同 table，驗證它們獨立計數</li>
            </ol>
        </div>
    </div>
</template>
